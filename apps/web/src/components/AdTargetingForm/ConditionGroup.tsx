...
export function ConditionGroup({ 
  ...
  const bgColor = depth === 0 ? '' : depth === 1 ? 'bg-secondary/50 border border-border' : 'bg-accent/50 border border-border';

  return (
    <div className={`relative ${isRoot ? '' : `${bgColor} rounded-lg p-4`}`}>
                    ...
                    <div className="flex items-center justify-center gap-3 my-4">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className={`h-8 px-4 text-sm font-medium rounded-md border transition-colors ${
